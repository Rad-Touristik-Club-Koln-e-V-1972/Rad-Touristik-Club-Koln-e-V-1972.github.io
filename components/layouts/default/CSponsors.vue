<template>
  <v-container id="CSponsors" fluid>
    <v-card flat>
      <v-card-title class="text-sm-caption text-md-body-2 text-lg-h5 text-xl-h4" v-text="'Unsere Partner'" />
      <v-row dense>
        <v-col v-for="sponsor in sponsors" :key="sponsor.text">
...
@Component
export default class CSponsors extends Vue {
  sponsors = [
    {
