...
`
    ...
    new GuestbookEntryBuilder()
        ...
        .pictureUrl('https://content.rtc-koeln.de/pages/guestbook/2015-10-17_20-01.jpg')
        .source(ESource.Facebook)
        .text(
            `
...
`
    ...
    new GuestbookEntryBuilder()
        ...
        .event(EEvent.CTF)
        .name('Thorsten Klein')
        .pictureUrl('https://content.rtc-koeln.de/pages/guestbook/2015-10-17_19-38.jpg')
        .source(ESource.Facebook)
        .text(
            `
Tolle Strecke.
...
`
    ...
    new GuestbookEntryBuilder()
        ...
        .event(EEvent.RTF)
        .name('Horst Paesch')
        .pictureUrl('https://content.rtc-koeln.de/pages/guestbook/2015-05-31_19-29.jpg')
        .source(ESource.Facebook)
        .text(
            `
