...
`
    ...
    new GuestbookEntryBuilder()
        ...
        .build(),
    new GuestbookEntryBuilder().date(2017, 10, 28, 21, 30).event(EventType.CTF).name('Mika Kali').source(SourceType.Facebook).text(`Wie immer: Klasse CTF ...`).build(),
    new GuestbookEntryBuilder()
        .date(2017, 10, 28, 21, 30)
        .event(EventType.CTF)
...
`
        ...
        .build(),
    new GuestbookEntryBuilder().date(2017, 10, 28, 21, 30).event(EventType.CTF).name('Andreas Diehl').source(SourceType.Facebook).text(`Schön war's ...`).build(),
    new GuestbookEntryBuilder()
        .date(2017, 10, 28, 21, 30)
        .event(EventType.CTF)
        .name('Jürgen Em')
...
`
    ...
    new GuestbookEntryBuilder()
        ...
        .build(),
    new GuestbookEntryBuilder().date(2017, 5, 29, 20, 30).event(EventType.RTF).name('Uli Fritzsche').source(SourceType.Facebook).text(`Und wir danken für die tolle Orga!`).build(),
    new GuestbookEntryBuilder()
