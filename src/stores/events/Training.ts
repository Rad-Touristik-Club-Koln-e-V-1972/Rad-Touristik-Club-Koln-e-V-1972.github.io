...
export default defineStore("training", () => {
  return {
    training: new TrainingBuilder()
      ...
      .setImages({
        "d631d58b-865c-4ee4-a468-e9a7414546a7":
          "content.rtc-koeln.de/pages/events/training/Wintertraining.jpg.avif",
        "fc5db804-222f-478c-b47e-d27ea3317374":
          "content.rtc-koeln.de/pages/events/training/Wintertraining2.jpg.avif"
      })
