...
export default [
  ...
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-03-14').setId('1cc7287d-66af-497e-8170-dc893dc275b9').setName('Mistral + Schwalmtal').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-03-21').setId('a84b90fc-3f90-4f44-ba8d-9d41c66be74c').setName('Düsseldorf Rath-Ratingen').buildEvent(),
  ...
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-04-06').setId('fac9ba4f-289e-4331-9c75-d72aa91ec350').setName('Sprinter Waltrop').buildEvent(),
  new EventBuilder()
    .setCategory(EEvent.Mitgliederversammlung)
    .setContact('Diana Vialon')
    .setDate('2026-04-10')
  ...
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-04-19').setId('04fc24a1-1183-438b-9bdb-a0aabca1d5c1').setName('Mülheim a.d. Ruhr (falls unsere Permanente samstags gefahren wird)').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-04-25').setId('e7cf0d70-e906-4c24-b8a4-0ae708f7e23e').setName('Grefrath').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-05-01').setId('daa374fc-9837-4bf4-93c4-452226eb8df2').setName('Refrath + Ochtendung').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-05-03').setId('5c2e6d62-4d54-4ae5-b85c-2e47118d7d8b').setName('Herne').buildEvent(),
  new EventBuilder()
    .setCategory(EEvent.Mitgliederversammlung)
    .setContact('Diana Vialon')
  ...
  new EventBuilder()
    ...
    .buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-05-09').setId('9b77f4a3-e1f7-4ec2-ac79-d1089da804cd').setName('Erftstadt').buildEvent(),
  ...
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-06-28').setId('2e2bdb33-5537-4bc5-b8ba-6b595a331d88').setName('Ford + Dinslaken + Ahrtal').buildEvent(),
  new EventBuilder()
    .setCategory(EEvent.Mitgliederversammlung)
    .setContact('Diana Vialon')
    .setDate('2026-07-03')
    ...
    .setName('RTC-Vereinsabend (Garten)')
    .buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-07-04').setId('7cb7a42d-5a5a-4536-a315-7c7a9b6a3c09').setName('Uckerath + Eslohe + St. Vith').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-07-05').setId('5c467f50-9bc1-48ba-ac62-f331f0c3b636').setName('Kerpen').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-07-12').setId('282bb339-8433-4b6d-8108-0269e8d22b0e').setName('Bundesradsporttreffen in Lünen (09.-12.07.)').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-07-19').setId('ea4e5aae-97aa-4b87-bf11-d2e05eec07fd').setName('Immendorf').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-07-26').setId('0c227b67-1173-493f-8fe3-f7fcf6b485a8').setName('Siegburg').buildEvent(),
  new EventBuilder().setCategory(EEvent.RTF).setDate('2026-08-01').setId('a3a0c598-a00f-4ad9-9a78-aa6a3b9696e7').setName('Lohmar').buildEvent(),
  new EventBuilder()
    .setCategory(EEvent.Mitgliederversammlung)
    .setContact('Diana Vialon')
    .setDate('2026-08-07')
