...
export default new EventBuilder()
  .setActive(!!useCalendarStore().getNextRTF(EEvent.RTF_Saison_Finale))
  ...
  .setFees(
    ...
    new FeeBuilder()
      ...
      .setName("Erwachsene mit Voranmeldung")
      .setPrice(10)
      .buildFee(),
    new FeeBuilder()
...
<span class='text-primary'>Um Voranmeldung für RTF und Party wird bis zum 07.10.2026 gebeten.</span>
