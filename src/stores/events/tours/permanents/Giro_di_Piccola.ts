...
export default new PermanentBuilder()
  ...
  .setControls(
    new ControlBuilder()
      .setCity("Köln")
      .setId("9618c580-baec-4213-8282-8f1f675c9f1c")
      .setStreet("Rather Mauspfad 19")
      .setTitle("Start/Ziel Piccola Gelateria")
      .setZipCode("51107")
      .buildControl(),
    new ControlBuilder()
      .setCity("Lindlar")
      .setId("9a29c0bf-8379-4c3c-9a7c-09c447243daf")
      .setStreet("Kölner Str. 16A")
      .setTitle("Kamps Bäckerei")
      .setZipCode("51789")
      .buildControl()
  )
  .setDonations(
...
BIC: GENODED1BRS`
    ...
    new DonationBuilder()
      ...
      .setTitle("PayPal")
      .setUrl("www.paypal.com/ncp/payment/4MGHM6L3PQVU8")
      .buildDonation()
  )
  .setHeight(950)
  ...
  .setUrls({
    "GPX-Datei": new URL(
      "https://content.rtc-koeln.de/pages/events/tours/permanents/Giro_di_Piccola/Giro_di_Piccola_Tour.gpx"
    )
  })
  .setText(
