...
export default defineStore('navigation', () => {
    const navigations = ref<Navigation[]>([
        ...
        new NavigationBuilder()
            .setChildren(
                new NavigationBuilder().setIcon(mdiCalendarClockOutline).setId('c4455a48-63ee-4e62-b140-f2686d7d71ce').setTitle('Vereinskalender').setTo('events-calendar').build(),
                new NavigationBuilder()
                    .setChildren(
                        new NavigationBuilder()
                            ...
                            .build(),
                        new NavigationBuilder().setIcon(mdiSnowman).setId('b53d7f6a-296d-45b6-b061-8a590bf89a20').setTitle('Wintertraining').setTo('events-wintertraining').build(),
                        new NavigationBuilder()
        ...
        new NavigationBuilder()
            .setChildren(
                new NavigationBuilder().setIcon(mdiInformationOutline).setId('1d102187-da26-46e9-bed3-9af22aa625d8').setTitle('Über uns').setTo('rtc-cologne-about-us').build(),
                new NavigationBuilder()
                    ...
                    .build(),
                new NavigationBuilder().setIcon(mdiImageMultiple).setId('d1718773-901a-42cd-ab49-3745d1a3a8b2').setTitle('Galerien').setTo('rtc-cologne-galleries').build(),
                new NavigationBuilder().setIcon(mdiMessageDraw).setId('d0900ba6-f50f-46d2-a5a9-c72cfee9dd58').setTitle('Gästebuch').setTo('rtc-cologne-guestbook').build(),
              ...
              .build(), */
                new NavigationBuilder()
                    ...
                    .build(),
                new NavigationBuilder().setIcon(mdiHumanCane).setId('244d210f-2151-427e-a1ed-3f767c034a50').setTitle('Alte Website').setUrl('old.rtc-koeln.de').build(),
            )
            .setIcon(mdiDomain)
