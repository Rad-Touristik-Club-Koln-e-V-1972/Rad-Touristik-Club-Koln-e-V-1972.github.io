  ...
  return {
    allNavigation: ref([
      ...
      new NavigationBuilder()
        ...
        .setId("ec9a422a-397b-4e2c-ad0b-0e64d5ec4c2f")
        .setTitle("Permanente")
        .setTo("/events/tours/permanents")
        .buildNavigation(),
      new NavigationBuilder()
        .setIcon(mdiStateMachine)
        .setId("d7096d1c-9230-42bd-989b-4e3b51bdde28")
        .setTitle("Etappenfahrt")
        .setTo("/events/tours/stagerace")
        .buildNavigation(),
      new NavigationBuilder()
        .setIcon(mdiHome)
        .setId("19e9c467-2c82-4894-a1d3-620565f56826")
        .setTitle("Startseite")
        .setTo("/")
        .buildNavigation(),
      new NavigationBuilder()
        .setChildren(
          new NavigationBuilder()
            .setIcon(mdiCalendarClockOutline)
            .setId("c4455a48-63ee-4e62-b140-f2686d7d71ce")
            .setTitle("Vereinskalender")
            .setTo("/events/calendar")
            .buildNavigation(),
          new NavigationBuilder()
            .setChildren(
              new NavigationBuilder()
              ...
              new NavigationBuilder()
                .setIcon(mdiStateMachine)
                .setId("b40b2143-ea94-4de5-9064-d65f8d839795")
                .setTitle("Etappenfahrt")
                .setTo("/events/tours/stagerace")
                .buildNavigation()
            )
          ...
          new NavigationBuilder()
            ...
            .setTo("/events/tours/rtfs/suggestions")
            .buildNavigation(),
          new NavigationBuilder()
            .setChildren(
              new NavigationBuilder()
      ...
      new NavigationBuilder()
        .setChildren(
          new NavigationBuilder()
            ...
            .setId("1d102187-da26-46e9-bed3-9af22aa625d8")
            .setTitle("Über uns")
            .setTo("/rtc-cologne/about-us")
            .buildNavigation(),
          new NavigationBuilder()
            ...
            .buildNavigation(),
          new NavigationBuilder()
            .setIcon(mdiImageMultiple)
            .setId("d1718773-901a-42cd-ab49-3745d1a3a8b2")
            .setTitle("Galerien")
            .setTo("/rtc-cologne/galleries")
            .buildNavigation(),
          new NavigationBuilder()
            .setIcon(mdiMessageDraw)
            .setId("d0900ba6-f50f-46d2-a5a9-c72cfee9dd58")
            .setTitle("Gästebuch")
            .setTo("/rtc-cologne/guestbook")
            .buildNavigation(),
          ...
          new NavigationBuilder()
            ...
            .buildNavigation(),
          new NavigationBuilder()
            .setIcon(mdiHumanCane)
            .setId("244d210f-2151-427e-a1ed-3f767c034a50")
            .setTitle("Alte Website")
            .setUrl("old.rtc-koeln.de")
            .buildNavigation()
        )
        .setIcon(mdiDomain)
        ...
        .buildNavigation(),
      new NavigationBuilder()
        .setIcon(mdiCurrencyEur)
        .setId("b7aa63ac-1e9a-44f3-80f6-4c2a8df8928b")
        .setTitle("Sponsoren")
        .setTo("/sponsors")
        .buildNavigation()
    ]),
    allSocialMedia: ref([
      new NavigationBuilder()
        .setColor("indigo")
        .setIcon(mdiFacebook)
        .setId("53558cbf-2289-4fba-9990-aee4fb7b336d")
        .setUrl("www.facebook.com/RTC.Koeln")
        .buildNavigation(),
      new NavigationBuilder()
        .setColor("red lighten-2")
        .setIcon(mdiInstagram)
        .setId("07d2f238-69ce-4a42-984c-dbfec9d2cbf8")
        .setUrl("www.instagram.com/rtckoeln")
        .buildNavigation(),
      new NavigationBuilder()
        .setColor("red lighten-2")
        .setIcon(mdiGoogle)
      ...
      new NavigationBuilder()
        .setIcon(mdiGithub)
        .setId("e2c05138-6078-4ed4-bbd6-8e0f5e7d0580")
        .setUrl("github.com/Rad-Touristik-Club-Koln-e-V-1972")
        .buildNavigation()
    ])
  };
});
