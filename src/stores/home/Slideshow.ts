  ...
  return {
    all: ref<GalleryEntry[]>([
      new GalleryEntryBuilder()
        ...
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/image0_61fe6032-2f8a-4344-a6cc-b91d395eca08.jpeg.avif')
        .buildGalleryEntry(),
      new GalleryEntryBuilder()
        .setId('c30f8886-41ba-47f6-bf97-b68bd8bb0baf')
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/image1_d322962f-3531-4248-8f64-f1fe3f3850b8.jpeg.avif')
        .buildGalleryEntry(),
      new GalleryEntryBuilder()
        .setId('1461e1b4-c418-4761-932f-3c6d660d79ec')
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/image2_4f36deec-6f19-4992-9ab3-3ea2a84b1572.jpeg.avif')
        .buildGalleryEntry(),
      new GalleryEntryBuilder()
        .setId('457576cf-03c8-4bb7-ab4f-444b6246dd47')
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/image3_e788fefb-5518-4e6c-a594-d93c96dfdfd2.jpeg.avif')
        .buildGalleryEntry(),
      ...
      new GalleryEntryBuilder()
        ...
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/b74ba152-d427-40ac-8ef4-4539bcb153e3.jpg.avif')
        .buildGalleryEntry(),
      new GalleryEntryBuilder()
        .setId('5109a7f7-f33f-4d14-ad34-135db19aea90')
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/b0a3d468-828d-474d-9380-e568a38fad89.jpg.avif')
        .buildGalleryEntry(),
      ...
      new GalleryEntryBuilder()
        ...
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/signal-2023-02-05-092407_002.jpeg.avif')
        .buildGalleryEntry(),
      new GalleryEntryBuilder()
        .setId('6236709d-d210-4301-a3ac-90fbf57b2cdb')
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/signal-2023-02-05-092407_003.jpeg.avif')
        .buildGalleryEntry(),
      ...
      new GalleryEntryBuilder()
        ...
        .setImageUrl('content.rtc-koeln.de/pages/home/slideshow/signal-2023-05-01-193158.jpeg.avif')
        .buildGalleryEntry(),
    ]),
  }
})
