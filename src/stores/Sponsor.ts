...
export default defineStore('sponsor', () => {
  return {
    all: ref<Sponsor[]>([
      new SponsorBuilder().setId('08ba12dc-1ff3-4441-8146-c59ac929e8a6').setImageUrl('content.rtc-koeln.de/pages/sponsor/Alpecin.svg').setUrl('www.alpecin.com/de-de/').buildSponsor(),
      ...
      new SponsorBuilder().setId('ce3f1eeb-7f0c-4ec0-b72c-0a7c68372091').setImageUrl('content.rtc-koeln.de/pages/sponsor/Garmin.svg').setUrl('www.garmin.com').buildSponsor(),
      new SponsorBuilder().setId('47765892-cb78-4898-a9c7-1f61a19b4284').setImageUrl('content.rtc-koeln.de/pages/sponsor/Ineos.webp').setUrl('www.ineos.com/sports/cycling/').buildSponsor(),
      new SponsorBuilder().setId('1bf98410-d65d-4d9d-8594-c7b0c1d62e17').setImageUrl('content.rtc-koeln.de/pages/sponsor/InnoBike.svg').setUrl('www.inno-bike.com').buildSponsor(),
      ...
      new SponsorBuilder().setId('247e0334-aec4-408c-9637-2889b1e65998').setImageUrl('content.rtc-koeln.de/pages/sponsor/RheinEnergie.svg').setUrl('www.rheinenergie.com').buildSponsor(),
      new SponsorBuilder().setId('748dc3ab-a086-46f2-a754-8d950f7aef9b').setImageUrl('content.rtc-koeln.de/pages/sponsor/RoseBikes.svg').setUrl('www.rosebikes.de').buildSponsor(),
