  ...
  return {
    all: ref<PressReport[]>([
      new PressReportBuilder()
        ...
        .setImages(new GalleryEntryBuilder().setId('37d52527-5e35-4410-b789-3801b10aabb9').setImageUrl('content.rtc-koeln.de/pages/gallery/2023/Rueckblick/signal-2023-05-10-105056.jpeg.avif').buildGalleryEntry())
        .setTitle('Porz am Montag')
        .buildPressReport(),
      new PressReportBuilder()
        .setDate('2022-12-06')
        .setId('df7bdf29-d6ad-4b8a-9a48-aa8ff8dfe176')
        .setImages(new GalleryEntryBuilder().setId('9ee7921e-2cd4-4a93-9a99-0fe1e1493713').setImageUrl('content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-12-06_porz-im-blick.jpg.avif').buildGalleryEntry())
        .setTitle('Porz im Blick')
        .buildPressReport(),
      new PressReportBuilder()
        .setDate('2022-11-14')
        .setId('f4682fd0-7b07-4e7b-9454-9a5b2dc710af')
        .setImages(new GalleryEntryBuilder().setId('eb1d1fd0-18a9-40a8-9d5f-9abafa7d3324').setImageUrl('content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-11-14_porz-am-montag.jpg.avif').buildGalleryEntry())
        .setTitle('Porz am Montag')
        .buildPressReport(),
      new PressReportBuilder()
        .setDate('2022-04-05')
