      ...
      new PressReportBuilder()
        ...
        .setImages(
          new GalleryEntryBuilder()
            ...
            .setImageUrl(
              "content.rtc-koeln.de/pages/gallery/2023/Rueckblick/signal-2023-05-10-105056.jpeg.avif"
            )
            .buildGalleryEntry()
        )
      ...
      new PressReportBuilder()
        ...
        .setImages(
          new GalleryEntryBuilder()
            ...
            .setImageUrl(
              "content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-12-06_porz-im-blick.jpg.avif"
            )
            .buildGalleryEntry()
        )
      ...
      new PressReportBuilder()
        ...
        .setImages(
          new GalleryEntryBuilder()
            ...
            .setImageUrl(
              "content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-11-14_porz-am-montag.jpg.avif"
            )
            .buildGalleryEntry()
        )
        .setTitle("Porz am Montag")
      ...
      new PressReportBuilder()
        ...
        .setImages(
          new GalleryEntryBuilder()
            ...
            .setImageUrl(
              "content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-05_roadbike.pdf"
            )
            .setPreviewUrl(
              "content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-05_roadbike.jpeg.avif"
            )
            .buildGalleryEntry()
        )
        .setTitle("Roadbike")
