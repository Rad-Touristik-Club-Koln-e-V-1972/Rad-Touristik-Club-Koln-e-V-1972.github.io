...
export default defineStore('rtc-cologne-contacts', () => {
  return {
    all: ref<Contact[]>([
      ...
      new ContactBuilder().setEMail('geschaeftsfuehrung@rtc-koeln.de').setId('ca74ca7f-79e3-4548-b851-8757a4ee17f7').setName('Tobias').setPosition('Geschäftsführung').buildContact(),
      ...
      new ContactBuilder().setEMail('sportwart@rtc-koeln.de').setId('5f48c322-ba0e-4866-be30-89702565522d').setName('Frank Prescha').setPosition('Sportwart').buildContact(),
