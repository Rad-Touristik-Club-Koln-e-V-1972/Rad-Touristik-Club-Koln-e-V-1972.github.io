...
export default new GalleryBuilder()
  ...
  .setImages([
    new GalleryEntryBuilder()
      ...
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2022/05_29_RTF_50/rtc-forsbach-tour-flyer1-2022.png.avif"
      )
      .buildGalleryEntry(),
    new GalleryEntryBuilder()
      .setId("cfda5413-aed1-4a1b-8d10-0dec402f15b1")
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2022/05_29_RTF_50/rtc-forsbach-tour-flyer2-2022.png.avif"
      )
      .buildGalleryEntry(),
    new GalleryEntryBuilder()
      .setId("0b9650bd-3449-4d9d-b17f-7cdad2d78af5")
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2022/05_29_RTF_50/Zugbeutel.jpeg.avif"
      )
      .buildGalleryEntry()
  ])
  .setImages(K1)
