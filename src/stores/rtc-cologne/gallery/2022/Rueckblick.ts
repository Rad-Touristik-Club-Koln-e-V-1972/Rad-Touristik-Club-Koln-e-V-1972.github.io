...
export default new GalleryBuilder()
    ...
    .setImages([
        new GalleryEntryBuilder()
            ...
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2022/Rueckblick/Nachruf_Klaus_Napierala.jpg.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-05_roadbike.pdf.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
    ...
    .setLocation('Köln')
    .setTitle('Rückblick')
    .setTitleImageUrl('content.rtc-koeln.de/pages/gallery/2022/Rueckblick/2022-05_roadbike.pdf.avif')
    .buildGallery()
