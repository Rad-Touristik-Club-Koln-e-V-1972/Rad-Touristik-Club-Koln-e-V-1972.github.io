...
export default new GalleryBuilder()
    ...
    .setImages([
        new GalleryEntryBuilder()
            ...
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5699.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('ab6dd745-9059-479a-a8cf-253b8f7a0a19')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5709.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('d299d3bf-7737-4a25-8506-cf61a6679ac7')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5710.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('6a369035-2bdc-4372-8963-8be72b462238')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5715.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('35d9542c-39d2-4881-a0c4-39ae051d4c10')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5717.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('831fb868-f169-41c7-9aad-9b28439879ee')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5718.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('14041211-68cf-48e7-8391-2fac61b52d5f')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5722.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('9a96ed63-94ac-487b-be26-266dffaaaace')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5724.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            .setId('3909475a-b9b8-486f-8081-15d57862d344')
            .setImageUrl('content.rtc-koeln.de/pages/gallery/2014/10_12_Saisonabschluss/DSCF5729.JPG')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
