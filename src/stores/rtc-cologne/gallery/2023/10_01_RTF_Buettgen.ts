...
export default new GalleryBuilder()
    ...
    .setImages([
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/48a9d169-7230-4cca-a80e-765fee6d04de.JPG.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/71f83add-e47c-451f-8a4a-fc7f3c224898 2.JPG.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/802ab202-6b6c-4b69-a0b0-ca18acfad390 2.JPG.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/838841bd-a22c-4fc1-bfa6-e8b5acc3a6d1.jpg.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/b33caf3c-a4e4-4aef-8fed-ad3841cbeaf4.JPG.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/C55CC9C5-F5B2-47E4-A34A-4668F6D91012.JPG.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/e96125f0-8bb8-4279-b46d-ccf9e84f4a8e.JPG.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/IMG_6169.JPG.avif')
            .buildGalleryEntry(),
        new GalleryEntryBuilder()
            ...
            .setPreviewUrl('content.rtc-koeln.de/pages/gallery/2023/10_01_RTF_Buettgen/IMG_6172.jpg.avif')
            .buildGalleryEntry(),
    ])
    .setLocation('Büttgen')
