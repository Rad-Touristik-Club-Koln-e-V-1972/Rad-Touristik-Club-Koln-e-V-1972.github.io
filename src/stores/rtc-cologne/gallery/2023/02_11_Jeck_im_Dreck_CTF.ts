...
export default new GalleryBuilder()
  ...
  .setImages([
    new GalleryEntryBuilder()
      ...
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/02_11_Jeck_im_Dreck_CTF/image0.jpeg.avif"
      )
      .buildGalleryEntry(),
    new GalleryEntryBuilder()
      .setId("98e9a979-6901-4b01-9c32-46d04362ed76")
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/02_11_Jeck_im_Dreck_CTF/image1.jpeg.avif"
      )
      .buildGalleryEntry()
  ])
  .setLocation("Hennef")
