...
export default new GalleryBuilder()
  ...
  .setImages([
    new GalleryEntryBuilder()
      ...
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/02_11_Wintertraining_d_Albert/image0.jpeg.avif"
      )
      .buildGalleryEntry(),
    new GalleryEntryBuilder()
      .setId("240d0aa9-e80d-417f-adb2-7e0c5172baee")
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/02_11_Wintertraining_d_Albert/image1.jpeg.avif"
      )
      .buildGalleryEntry()
  ])
