...
export default new GalleryBuilder()
  ...
  .setImages([
    new GalleryEntryBuilder()
      ...
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/03_17_Fruehlingsfahrt_nach_Lindlar/image0.jpeg.avif"
      )
      .buildGalleryEntry(),
    new GalleryEntryBuilder()
      .setId("d4b17242-002a-43fd-9e4a-26c804446abc")
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/03_17_Fruehlingsfahrt_nach_Lindlar/image1.jpeg.avif"
      )
      .buildGalleryEntry(),
    new GalleryEntryBuilder()
      .setId("88c69e37-3c3f-4706-9906-5b2b56fcc345")
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/03_17_Fruehlingsfahrt_nach_Lindlar/image2.jpeg.avif"
      )
      .buildGalleryEntry()
  ])
  .setLocation("Lindlar")
