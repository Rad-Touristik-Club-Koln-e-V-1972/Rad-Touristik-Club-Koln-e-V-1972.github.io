...
export default new GalleryBuilder()
  ...
  .setImages([
    new GalleryEntryBuilder()
      ...
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/03_03_Generationenwechsel/IMG_6157.jpg.avif"
      )
      .buildGalleryEntry(),
    new GalleryEntryBuilder()
      .setId("4a2f521a-0dfe-4388-80e5-8658de8a0b65")
      .setImageUrl(
        "content.rtc-koeln.de/pages/gallery/2023/03_03_Generationenwechsel/IMG_6154.jpg.avif"
      )
      .buildGalleryEntry()
  ])
  .setLocation("Köln")
