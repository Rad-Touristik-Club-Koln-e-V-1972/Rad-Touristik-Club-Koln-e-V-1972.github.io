...
export default class GalleryBuilder extends ABuilder {
  ...
  setImages = (
    value: Record<string, GalleryEntry[]> | GalleryEntry[] | GalleryEntry
  ): this => {
    if (Array.isArray(value))
      this.gallery.images = Object.assign(this.gallery.images, {
        "Ohne Album": value
      });
    else if (value.constructor === GalleryEntry)
      this.gallery.images = Object.assign(this.gallery.images, {
        "Ohne Album": [value]
      });
    else
      this.gallery.images = Object.assign(
        this.gallery.images,
        value as Record<string, GalleryEntry[]>
      );
