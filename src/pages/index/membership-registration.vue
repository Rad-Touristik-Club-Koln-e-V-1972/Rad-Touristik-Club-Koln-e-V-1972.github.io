<template>
  <q-card flat>
    <q-card-section class="bg-primary text-accent text-h6"
      >Mitgliedschaft beantragen</q-card-section
    >
    <q-tabs
      v-model="tab"
    ...
    <q-tab-panels v-model="tab">
      <q-tab-panel name="infos">
        <q-card-section class="text-subtitle1">
          <div class="row">
            <div class="col-auto">
              Es gibt viele Vorteile, wenn man in einem Radsportverein Mitglied
              ist.
              <br />
              <b
                >Wir freuen uns, dass Du Dich dazu entschieden hast, dem RTC
                Köln e.V. 1972 beizutreten.</b
              >
              <br />
              Dazu müsstest Du bitte noch das Formular im Tab "Bewerbung"
            ...
            <div class="col-auto q-mt-sm">
              ...
              BIC: GENODED1BRS
              <br />
              <a href="https://www.rtc-koeln.de" target="_blank"
                >www.rtc-koeln.de</a
              >
            </div>
          </div>
            ...
            <div class="col-auto">
              <q-card>
                <q-card-section class="bg-primary text-accent"
                  >Beitragstabelle</q-card-section
                >
                <q-card-section>
                  <q-markup-table flat>
                    <thead>
                    ...
                    <tbody>
                      <tr
                        v-for="it in useMembershipRegistrationStore().fees.filter(
                          f => f.name
                        )"
                        :key="it.id"
                      >
                ...
                <q-card-section class="text-body2"
                  >Der RTC Köln bezuschusst den Kauf des Vereinstrikots einmalig
                  mit 25,00 EUR.</q-card-section
                >
              </q-card>
            </div>
            <div class="col-1" />
        ...
        <q-card-section>
          <q-stepper v-model="step" animated vertical>
            ...
            <q-step
              :done="step > 7"
              :name="7"
              title="Einwilligungserklärung Datenverarbeitung"
            >
              <q-stepper-navigation>
...
import MembershipRegistrationBuilder from "@/models/builder/MembershipRegistrationBuilder";
import BdrMembershipBuilder from "@/models/builder/membership-registration/BdrMembershipBuilder";
import MembershipFeeBuilder from "@/models/builder/membership-registration/MembershipFeeBuilder";
import PersonalDataBuilder from "@/models/builder/membership-registration/PersonalDataBuilder";
import SignatureBuilder from "@/models/builder/membership-registration/SignatureBuilder";
...
const images = [
  new GalleryEntryBuilder()
    ...
    .setImageUrl(
      "content.rtc-koeln.de/pages/membership-registration/Din-A4-Flyer-Vorteile-Verein-RGB.pdf"
    )
    .setPreviewUrl(
      "content.rtc-koeln.de/pages/membership-registration/Din-A4-Flyer-Vorteile-Verein-RGB.avif"
    )
    .buildGalleryEntry()
];
const step = ref(1);
