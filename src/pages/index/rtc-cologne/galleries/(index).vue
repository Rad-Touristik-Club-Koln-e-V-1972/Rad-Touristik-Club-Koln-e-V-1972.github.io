<template>
  <q-card flat>
    <q-card-section class="bg-primary text-accent text-h6"
      >Galerien</q-card-section
    >
    <q-card-section>
      <span class="text-subtitle1">Fotos und Videos des RTC-Köln</span>
      <br />
      <span class="text">
        Falls du keine Fotos siehst, schau bitte nach, ob dein Browser
        unterstützt wird:
        <br />
        <a href="https://caniuse.com/?search=avif" target="_blank"
          >https://caniuse.com/?search=avif</a
        >
      </span>
    </q-card-section>
    <q-card-section>
