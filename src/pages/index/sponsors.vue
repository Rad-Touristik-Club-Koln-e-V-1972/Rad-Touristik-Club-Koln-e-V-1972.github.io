<template>
  <q-card flat>
    <q-card-section class="bg-primary text-accent text-h6"
      >Unsere Sponsoren</q-card-section
    >
    <q-card-section>
      Ein herzliches Dankeschön für all die Unterstützung, ohne die unsere
      Veranstaltungen nicht machbar wären.
      <br />
      Auch all denjenigen, die um Diskretion gebeten haben, sind wir sehr
      verbunden!
    </q-card-section>
    <q-card-section>
      ...
      <masonry-wall :column-width="280" :gap="3" :items="useSponsorStore().all">
