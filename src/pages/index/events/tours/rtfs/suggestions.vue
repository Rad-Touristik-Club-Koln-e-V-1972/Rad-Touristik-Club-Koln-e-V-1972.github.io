<template>
  <q-card flat>
    <q-card-section class="bg-primary text-accent text-h6"
      >Empfohlene RTF's außerhalb NRW</q-card-section
    >
    <q-card-section class="text-subtitle1">
      Viele unserer Vereinsmitglieder sind diese Radsportveranstaltungen
      außerhalb von NRW in den vergangenen Jahren gefahren und fanden sie sehr
      schön.
      <br />
