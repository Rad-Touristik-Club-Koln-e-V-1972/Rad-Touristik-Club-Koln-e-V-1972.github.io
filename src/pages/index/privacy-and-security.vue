<template>
  <q-card flat>
    <q-card-section class="bg-primary text-accent text-h6"
      >Datenschutzerklärung</q-card-section
    >
    <q-card-section class="text-h5"
      >1. Datenschutz auf einen Blick</q-card-section
    >
    ...
    <q-card-section class="text-h6"
      >Datenerfassung auf dieser Website</q-card-section
    >
    <q-card-section class="text-subtitle1"
      >Wer ist verantwortlich für die Datenerfassung auf dieser
      Website?</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-subtitle1"
      >Wie erfassen wir Ihre Daten?</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-subtitle1"
      >Wofür nutzen wir Ihre Daten?</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-subtitle1"
      >Welche Rechte haben Sie bezüglich Ihrer Daten?</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h5"
      >3. Allgemeine Hinweise und Pflichtinformationen</q-card-section
    >
    ...
    <q-card-section class="text-h6"
      >Hinweis zur verantwortlichen Stelle</q-card-section
    >
    <q-card-section
    ...
    <q-card-section>
      ...
      Tools aktiv sind, können Ihre personenbezogene Daten in diese Drittstaaten
      ...
      als Betroffener hiergegen gerichtlich vorgehen könnten. Es kann daher
      nicht ausgeschlossen werden, dass US-Behörden (z. B. Geheimdienste) Ihre
    ...
    <q-card-section class="text-h6"
      >Widerruf Ihrer Einwilligung zur Datenverarbeitung</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h6"
      ...
      gegen Direktwerbung (Art. 21 DSGVO)</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h6"
      >Beschwerderecht bei der zuständigen Aufsichtsbehörde</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h6"
      >Recht auf Datenübertragbarkeit</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h6"
      >Auskunft, Löschung und Berichtigung</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h6"
      >Recht auf Einschränkung der Verarbeitung</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h6"
      >SSL- bzw. TLS-Verschlüsselung</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h5"
      >4. Datenerfassung auf dieser Website</q-card-section
    >
    ...
    <q-card-section class="text-h6"
      >Anfrage per E-Mail, Telefon oder Telefax</q-card-section
    >
    <q-card-section>
    ...
    <q-card-section class="text-h6"
      >YouTube mit erweitertem Datenschutz</q-card-section
    >
    <q-card-section>
      Diese Website bindet Videos der Website YouTube ein. Betreiber der Seiten
    ...
    <q-card-section>
      ...
      erhalten. Diese Informationen werden u. a. verwendet, um Videostatistiken
    ...
    <q-card-section
      >Quelle:
      <a href="https://www.e-recht24.de">e-recht24.de</a></q-card-section
    >
  </q-card>
</template>
