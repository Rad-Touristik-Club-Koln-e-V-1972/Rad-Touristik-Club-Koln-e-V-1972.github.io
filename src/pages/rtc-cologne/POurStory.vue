<template>
    <q-card flat>
        ...
        <q-card-section>
            ...
            Die Kurzform RTC wurde später von vielen Vereinen kopiert, aber der Grundgedanke, den Breitensport zu betreiben und zu fördern, wurde als Erstes durch den RTC Köln
            definiert und wird bis heute von Vorstand und Mitgliedern des Vereins gelebt.
        </q-card-section>
        <q-card-section>
            ...
            Seit dem Gründungsjahr werden RTF durchgeführt, in den Anfängen neben der Forsbachtour auch das Bergische Karussell, diese Strecke ist heute noch als eine unserer
            beiden Permanenten erhalten.<br />
            <br />
        ...
        <q-card-section>
            ...
            Die jeweiligen Mannschaften sowie Einzelmitglieder wurden jeweils 5mal Bundessieger.<br />
            <br />
        ...
        <q-card-section>
            Für die Statistiker: 1974 gab es in der damaligen BRD 22 offizielle RTF-Veranstaltungen, 1979 waren es 90 und 1980 schon 160.<br />
            Im Jahr 2014 wurden im Breitensportkalender des BDR als Veranstaltungen 610 RTF, 122 Radmarathons, 239 CTF und 1000 Permanente aufgeführt.
        </q-card-section>
    </q-card>
</template>
