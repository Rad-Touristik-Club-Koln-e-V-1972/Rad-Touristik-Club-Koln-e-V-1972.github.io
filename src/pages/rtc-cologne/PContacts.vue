<template>
  <q-card flat>
    <q-card-section class="bg-primary text-accent text-h6">Kontakte</q-card-section>
...
const imageUrls = ref([{  imageUrl: new URL('https://content.rtc-koeln.de/pages/rtc-cologne/contacts/IMG_9235.jpg.avif').buildGalleryEntry()])
</script>
