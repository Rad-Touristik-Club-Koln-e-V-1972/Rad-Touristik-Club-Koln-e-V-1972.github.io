    ...
    <v-card id="VContact" flat>
        <v-card-title>
            <v-toolbar color="primary" flat>
                <v-toolbar-title class="accent--text text-body-1 text-sm-body-2 text-md-h6 text-lg-h5 text-xl-h4">Kontakte</v-toolbar-title>
            </v-toolbar>
        </v-card-title>
        ...
        <v-card-text>
            ...
            <masonry-wall :column-width="280" :gap="16" :items="useContactsStore().all">
