...
export default [
  {
    category: EEvent.CTF,
    date: new Date('2015-10-19 12:55'),
    name: 'Claude-Antoine Berger de Leon',
    source: ESource.Facebook,
    text: `Auch von meiner Seite einen großen Dank an den Veranstalter, der einen enormen Aufwand betrieben hat.
...
und dass auch vielleicht noch einige andere Vereine aus der Region die für Viele noch etwas unbekannte Veranstaltung in Angriff nehmen ...`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-18 18:43'),
    name: 'Helmut Kanthak',
...
Helmut vom RSC Nievenheim`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-18 14:23'),
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-18 14:22'),
    name: 'Jür Jen',
    source: ESource.Facebook,
    text: `... die sich die Zeit genommen haben und die tolle Arbeit für uns Teilnehmer gemacht habt!!
...
Hoffentlich gibt es nächstes Jahr die 2. Wahnbach-Tour, ich bin wieder dabei .....`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-18 13:49'),
    name: "Manuela 'Ela' Huber",
    source: ESource.Facebook,
    text: `total nette Crew - super Strecke - hat viel Spaß gemacht!!
gerne wieder!!`,
  },
  {
    category: EEvent.CTF,
    date: new Date('2015-10-18 10:33'),
    name: 'Jo Di',
    source: ESource.Facebook,
    text: `Ihr seid ein richtig nettes Team und ein toller Verein, da konnte das Wetter doch nur mitmachen.
...
Guido Faßbender`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 21:02'),
    name: 'Schonneb Aus Lev',
    source: ESource.Facebook,
    text: `Hallo Zusammen,
...
Ich würde mich auf ein nächstes Mal sehr freuen.`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 20:45'),
...
Henning`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 20:01'),
    galleryEntries: [{ imageUrl: new URL('https://content.rtc-koeln.de/pages/guestbook/2015-10-17_20-01.jpg.avif') }],
    name: 'Wilfried Goesgens',
    source: ESource.Facebook,
    text: `Auch wenn ich das Startfenster leicht gerissen habe und nur die kurze Tour nehmen konnte 😕
Superrunde und hoffentlich nächstes Jahr wieder ...`,
  },
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 19:38'),
    galleryEntries: [{ imageUrl: new URL('https://content.rtc-koeln.de/pages/guestbook/2015-10-17_19-38.jpg.avif') }],
    name: 'Thorsten Klein',
    source: ESource.Facebook,
    text: `Tolle Strecke.
Hat Spaß gemacht.
...
Hier auch noch ein Bild von dem Ausblick auf der Strecke.`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 19:03'),
    name: 'Sabine Riehl',
    source: ESource.Facebook,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 18:57'),
    name: 'Jörg Hengster',
    source: ESource.Facebook,
    text: `Super Tour heute!
...
Danke RTC!`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 17:52'),
    name: 'Bernd Doelp',
    source: ESource.Facebook,
    text: `Hallo RTC,
...
Bernd Doelp`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 16:45'),
    name: 'Ben Feld',
    source: ESource.Facebook,
    text: `Danke für die schöne Veranstaltung!
...
Wiederholung im nächsten Jahr ist ausdrücklich erwünscht.`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2015-10-17 16:07'),
...
Stephan`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-06-03 20:16'),
    name: 'Guido Faßbender',
...
Grenzfahrer e.V.`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-06-03 12:36'),
    name: 'Frank Koch',
    text: `Reiskuchen,
...
schöne Grüße aus Troisdorf Frank 😊`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-06-02 10:45'),
    name: 'Frank Oesterheld',
    source: ESource.Facebook,
    text: `Die Versorgungen an allen "K" super und vor allem die Supporter hilfsbereit, nett und gut gelaunt ...
...
Bis zum nächsten Jahr 😊`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-06-01 22:47'),
    name: 'Gerhard Veeh',
    source: ESource.Facebook,
    text: `Wir, der RTC-Mehlem 1984 e. V., waren nur zu zweit am Start wg. der Terminkollision mit ByBike.
...
Danke Euch für die tolle Organisation.`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-06-01 20:33'),
    name: 'Fam Rossol',
    organization: '1. RTW-Sankt Augustin-Menden',
    text: `Nach der ersten Kontrolle haben wir uns aufgeteilt und in Gruppen die 70er, 100er und die 150er Strecke unter die Räder genommen.
...
Die Radsportfreunde vom 1. RTW-Sankt Augustin-Menden`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-06-01 15:57'),
...
Beste Marathon-Veranstaltung, die ich bisher gefahren bin (und das sind nicht wenige!)`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-06-01 14:14'),
    name: 'Yvonne Basinski',
    source: ESource.Facebook,
    text: `Total schöne Tour.
...
Marc`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-05-31 20:30'),
    name: 'Petra Ak',
    source: ESource.Facebook,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-05-31 20:19'),
    name: 'Thomas Mühl',
    source: ESource.Facebook,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-05-31 20:11'),
    name: 'Michael Kalisch',
    source: ESource.Facebook,
    title: 'top top top 😊',
  },
  {
    category: EEvent.RTF,
    date: new Date('2015-05-31 20:10'),
    name: 'Horst Voll',
    source: ESource.Facebook,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2015-05-31 19:29'),
    galleryEntries: [{ imageUrl: new URL('https://content.rtc-koeln.de/pages/guestbook/2015-05-31_19-29.jpg.avif') }],
    name: 'Horst Paesch',
    source: ESource.Facebook,
    text: `Danke für ein perfekt organisierten Marathon, die Strecke war super ausgesucht, viele ruhige Straßen, tolle Ausblicke!
