...
export default [
  {
    category: EEvent.CTF,
    date: new Date('2018-10-28 00:00'),
    name: 'Andreas Reineke',
    source: ESource.Facebook,
    text: `Schöne Strecke - aber die Markierungsdiebe waren zu aktiv.
...
Es war eine sehr schöne Veranstaltung.`,
  },
  {
    ...
    name: 'Vamos Bala',
    source: ESource.Facebook,
    text: `Orga an Start/Ziel super und sehr nette motivierte Helfertruppe ...
Schön, dass Ihr die Veranstaltung gewuppt bekommt und sie auch weiter macht ...`,
  },
  {
    category: EEvent.CTF,
    date: new Date('2018-10-27 16:36'),
    name: 'Bernd Doelp',
    text: `Hallo RTC,
...
Bernd`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2018-05-28 17:00'),
  ...
  },
  {
    ...
    name: 'Jochen Güttes',
    source: ESource.Facebook,
    text: `Wir Teilnehmer sind begeistert.
...
161 km RTF Strecke und dann nach Hause waren dann für mich bei meiner ersten RTF in diesem Jahr ein Marathon ... 😊`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2018-05-27 17:01'),
...
Harry`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2018-05-27 13:54'),
    name: 'Dirk Oliver Heppert',
    organization: 'RSV Staubwolke Refrath',
    text: `Hallo RTC, ich/wir wollte/n nur sagen, dass ... ich wieder total begeistert bin von Eurer RTF.
