...
Rolf Müller, Cito Hennef-Geistingen`,
  },
  {
    ...
    category: EEvent.CTF,
    date: new Date('2016-10-30 20:30'),
    location: 'Hürth Berrenrath',
    name: 'Stefan Schneider',
    organization: 'RV Morgenstern',
    source: ESource.Facebook,
    text: `Die CTF war gestern erste Sahne, nur bei den Flatterbändern hättet ihr das eine oder andere mehr aufhängen können.
...
Wie viele Teilnehmer hattet ihr eigentlich?`,
  },
  {
    ...
    category: EEvent.CTF,
    date: new Date('2016-10-29 19:21'),
    name: 'Jörg Moritz',
    text: `Hallo RTC,
...
Jörg Moritz`,
  ...
  {
    category: EEvent.CTF,
    date: new Date('2016-10-29 20:30'),
    name: 'Jürgen Rohr',
    source: ESource.Facebook,
    text: `Schöne Runde bei gutem Wetter und sehr guter Verpflegung.
Hat Spaß gemacht.
Vielen Dank an das Orga-Team!!!`,
  },
  {
    ...
    name: 'Horst Paesch',
    source: ESource.Facebook,
    text: `Wenn ich mal was konstruktives sagen darf, es war eine super spannende CTF, sehr abwechslungsreich,
...
Sollte mehr davon bei uns hier geben 😊`,
  ...
  },
  {
    ...
    name: 'Jörg Marso',
    source: ESource.Facebook,
    text: `Es hat super viel Spaß gemacht und die Verpflegung war Spitze.
...
Wir sehen uns dann 2017.`,
  },
  {
    ...
    name: 'Marcus Wilden',
    source: ESource.Facebook,
    text: 'Schöne Tour bei bestem Wetter',
  },
  {
    category: EEvent.RTF,
    date: new Date('2016-05-31 1:34'),
    name: 'Gunter Maier',
    source: ESource.Facebook,
    text: `Mir kommt es auch so vor als ob ich zugenommen habe, trotz der drei Varianten die wir gefahren sind (welche sich mMn auch sehr gelohnt haben).
...
Ich wollte es trotzdem loswerden, da wir uns gestern schon auf der Strecke darüber unterhalten haben.`,
  },
  {
    ...
    name: 'Lutz Schröder',
    source: ESource.Facebook,
    text: `Und im nächsten Jahr gibt's bei der Warmverpflegung für die Vegetarier wenigstens ein Ketchup als Alternative zum Gulasch ??
...
Ansonsten vielen Dank für die tolle Organisation und die schöne Strecke.`,
  ...
  },
  {
    ...
    name: 'Andreas Klemt',
    source: ESource.Facebook,
    text: 'Sehr gut: Der Reiskuchen!',
  },
  {
    category: EEvent.RTF,
    date: new Date('2016-05-30 14:46'),
...
LG Martin`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-30 13:04'),
...
Danke an alle Helfer und das Orga Team!`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 20:50'),
    name: 'Alexandra Raj',
    organization: 'FB-Gruppe RTF und CTF - Radtourenfahrten des BDR (Bund Deutscher Radfahrer e.V.,',
    source: ESource.Facebook,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 20:33'),
    name: 'Roland Liffers',
    source: ESource.Facebook,
    text: `... schließe mich dem Lob von David Pandya vollumfänglich an, man kann es tendenziell nicht besser machen ...
Nächstes Jahr wird wieder die 1000er Marke geknackt 😀`,
    title: 'Tolle Stullen, die 2.',
  },
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 20:20'),
    name: 'Ludger Thier',
    organization: 'FB-Gruppe RTF und CTF - Radtourenfahrten des BDR (Bund Deutscher Radfahrer e.V.,',
    source: ESource.Facebook,
    text: `Wer sich heute trotz der besch... Wettervorhersage der "bergischen Herausforderung des RTC Köln" mit 2700hm auf knappen 200km gestellt hat,
...
Bis nächstes Jahr!`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 19:46'),
    name: 'Angela Maja',
    source: ESource.Facebook,
    text: `Ich bedanke mich bei allen Beteiligten, die diese wunderbare Veranstaltung wieder möglich gemacht haben:
...
Ich freute mich, dass ich heute weder auf der 160 km Strecke noch auf dem anschl. Weg nach Hause von Gewitter oder Regen überrascht wurde - sondern eher von der Sonne.`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 19:11'),
    name: 'David Pandya',
    organization: 'The Racing Club Rush (Gemeinschaft via Facebook,',
    source: ESource.Facebook,
    text: `Vielen vielen vielen lieben Dank RTC Köln e. V. 1972.
...
Chapeau!`,
  ...
  },
  {
    ...
    name: 'Petra Ba',
    source: ESource.Facebook,
    text: 'Ein super Tag, und super Wetter ...',
  },
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 17:38'),
    name: 'Bernd Doelp',
    source: ESource.Facebook,
...
Super Wetter mit reichlich Sonne auf knapp 200km ...`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 16:12'),
    name: 'Horst Voll',
    source: ESource.Facebook,
    text: `War echt stark ...
...
Die 200er war geil und, Nudeln mit Gulasch waren echt lecker ...`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 16:06'),
    name: 'Horst Paesch',
    organization: 'RSC Erftstadt',
    source: ESource.Facebook,
    text: `Sitzen noch im Ziel und besaufen uns mit Alkoholfreiem Weizen ...
...
Top! 👍`,
  },
  {
    ...
    name: 'Se Sandra',
    source: ESource.Facebook,
    text: `War 'ne schöne Strecke und Verpflegung war reichlich da an den Kontrollstellen! 👍 👍
...
Was ist das? 😉`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 14:36'),
    name: 'Ros Si',
    source: ESource.Facebook,
    text: `War eine super 158er RTF.
...
Vielen Dank an den RTC.`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 14:00'),
  ...
  {
    category: EEvent.RTF,
    date: new Date('2016-05-29 13:52'),
    name: 'Jochen Güttes',
    source: ESource.Facebook,
    text: `Das mit das mit dem Wettergott hat hervorragend funktioniert.
