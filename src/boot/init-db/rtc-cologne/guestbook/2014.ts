...
export default [
  {
    date: new Date('2014-06-19 18:43'),
    name: 'Helga Hasberg',
    text: `Hallo RTC,
...
Helga`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-28 12:36'),
    name: 'Jessica Bosen',
    text: `Hallo RTC,
...
Jessica`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-27 13:10'),
    name: 'velotoerist',
    text: `Hallo RTC,
...
velotoerist`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-27 12:59'),
    name: 'Helmut Hane',
    organization: 'www.sportlich-radeln.de',
    text: `Prima RTF am vergangenen Sonntag.
...
Marco Gerlach`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-27 9:26'),
    name: 'Jörg Homann',
    organization: 'www.scan.bike`',
    text: `Ein langer Tag, nicht nur für die Fahrer auf den langen Strecken der Forsbach-Tour 2014, nein, auch für die Helfer des veranstaltenden Vereins RTC Köln 1972 e.V.
...
http://scan.bike`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-27 6:49'),
    name: 'Norbert Priefert',
    text: `Jetzt muss man hier aber mal einen Punkt machen und in die Bresche springen.
...
Norbert`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 20:16'),
    location: 'Recklinghausen',
    name: 'Jörg Freitag',
    text: `Hallo lieber RTC,
...
Jörg`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 16:57'),
    name: 'Markus Reckter',
...
RTF Koblenz`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 13:08'),
    name: 'Claudia Braun',
...
Union Biesfeld Triathlon`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 12:50'),
    name: 'Angela Schmilewski',
    organization: 'Fachwart RTC Mehlem',
    text: `Liebe Orga des RTC Köln,
...
Ein herzliches Dankeschön an Orga und Helfer und Euch allen eine gute Regeneration – die habt Ihr Euch jetzt verdient….`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 12:43'),
    name: 'Dirk Brieden',
    text: `Hallo RTC,
...
PS: Hätte schon gedruckt werden müssen, da in der Zwischenzeit schon 2 neue Meinungen „reingestellt“ wurden.`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 10:55'),
    name: 'Dirk Brieden',
    text: `Wir sind gestern euren Marathon gefahren.
...
Wir sind enttäuscht von eurer Veranstaltung und kommen nicht nochmal wieder ☹`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 10:49'),
...
vom VfB Polch Abtl. Radsport.`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 10:33'),
    name: 'Frank Stöcker',
    text: `Hallo RTC,
...
nächstes Jahr will ich wieder meine Banane bekommen ;)`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 7:24'),
    location: 'Berrenrath',
    name: 'Stefan Schneider',
    organization: 'RV Morgenstern',
    text: `Hallo Sportskollegen vom RTC Köln.
...
1.Vorsitzender RV Morgenstern Berrenrath`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-26 7:06'),
    name: 'Norbert Priefert',
    organization: 'www.rtc-rodenkirchen.de',
    text: `Hallo RTC Köln´ner,
...
Norbert`,
  ...
  {
    category: EEvent.RTF,
    date: new Date('2014-05-25 19:44'),
...
Jürgen Ruttkowski`,
  ...
  {
    date: new Date('2014-01-17 11:09'),
    name: 'Roland Schultz',
    text: `Hallo RTC,
