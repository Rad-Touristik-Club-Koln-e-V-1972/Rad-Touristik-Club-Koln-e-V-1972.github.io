<template>
    <v-menu id="CDatePicker" v-model="menu" :close-on-content-click="false" min-width="auto" offset-y transition="scale-transition">
        <template #activator="{ on, attrs }">
            <v-text-field :dense="dense" :label="props.label" :prepend-icon="mdiCalendar" readonly :value="props.value" v-bind="attrs" v-on="on" />
        </template>
...
const props = defineProps({
    ...
    value: { default: '', required: true, type: String },
})
