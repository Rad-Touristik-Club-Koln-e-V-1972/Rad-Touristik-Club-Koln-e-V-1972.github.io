<template>
  <q-card-section>
    ...
    <div class="row">
      <div class="col">Das Vereinsmitglied trifft die Entscheidung zur Veröffentlichung seiner Daten im Internet freiwillig und kann seine Einwilligung jederzeit widerrufen.</div>
    </div>
    <div class="row">
      <div class="col">
    ...
    <div class="row">
      <div class="col">wie angegeben in folgender Internetseite des Vereins <a href="https://www.rtc-koeln.de" target="_blank">www.rtc-koeln.de</a> veröffentlichen darf."</div>
    </div>
    <div class="row">
      <div class="col">
