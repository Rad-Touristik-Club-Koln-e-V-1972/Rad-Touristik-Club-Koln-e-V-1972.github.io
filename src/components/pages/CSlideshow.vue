    ...
    >
        ...
        <template #control>
            <q-carousel-control v-if="props.galleryEntries.length > 1" position="bottom-left" style="z-index: 1">
                <q-btn color="primary" :icon="mdiArrowLeft" round size="md" text-color="accent" @click="previous()" />
            </q-carousel-control>
            <q-carousel-control v-if="props.galleryEntries.length > 1" position="bottom-right" style="z-index: 1">
                <q-btn color="primary" :icon="mdiArrowRight" round size="md" text-color="accent" @click="next()" />
            </q-carousel-control>
        </template>
    </q-carousel>
</template>
