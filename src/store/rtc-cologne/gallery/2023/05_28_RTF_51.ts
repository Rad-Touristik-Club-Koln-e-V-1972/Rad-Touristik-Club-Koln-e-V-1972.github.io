...
import StartZiel from '~/store/rtc-cologne/gallery/2023/05_28_RTF_51/Start_Ziel'
import Vorbereitungen from '~/store/rtc-cologne/gallery/2023/05_28_RTF_51/Vorbereitungen'
