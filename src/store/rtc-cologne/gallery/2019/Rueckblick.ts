...
export default new GalleryBuilder()
    ...
    .setImages(
        new GalleryEntryBuilder().setId('8f37bf18-d319-4577-9c6c-9444213c190c').setImageUrl('content.rtc-koeln.de/pages/gallery/2019/Rueckblick/rtc-960-intro-2019.jpg').build()
    )
    .setLocation('Köln')
    .setTitle('Rückblick')
