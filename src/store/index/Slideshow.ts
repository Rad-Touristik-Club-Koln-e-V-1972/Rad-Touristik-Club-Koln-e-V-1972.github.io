...
export const useSlideshowStore = defineStore('slideshow', () => {
    const images = ref<GalleryEntry[]>([
        ...
        new GalleryEntryBuilder().setId('d7626722-ac6f-449a-b333-180cd2e41ccd').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/signal-2023-02-05-092407_002.jpeg').build(),
        new GalleryEntryBuilder().setId('6236709d-d210-4301-a3ac-90fbf57b2cdb').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/signal-2023-02-05-092407_003.jpeg').build(),
        ...
        new GalleryEntryBuilder().setId('701c5a44-9ce5-413f-8cac-a292b8a1f29f').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image4.jpeg').build(),
        new GalleryEntryBuilder().setId('8ebc1829-5eba-4eeb-a330-a57571cb21e2').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image7.jpeg').build(),
        new GalleryEntryBuilder().setId('5be8f287-e466-4e32-bb01-bb346f8b5e4f').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image8.jpeg').build(),
        new GalleryEntryBuilder().setId('8d945549-abb5-4504-9e99-65d283c9eacc').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image9.jpeg').build(),
        new GalleryEntryBuilder().setId('f55db621-c358-4b93-bb7e-53bfc90961cb').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image10.jpeg').build(),
        new GalleryEntryBuilder().setId('519ddc33-9bb8-424a-989a-c0af65ca7c22').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image11.jpeg').build(),
        new GalleryEntryBuilder().setId('cf006b15-4980-43bc-b60f-59e43f2e8965').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image12.jpeg').build(),
        new GalleryEntryBuilder().setId('437682e5-20d5-4d5c-9dba-15d58108cd98').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image13.jpeg').build(),
