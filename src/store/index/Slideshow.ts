...
export const useSlideshowStore = defineStore('slideshow', {
    ...
    state: () => ({
        images: [
            new GalleryEntryBuilder().setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image0.jpeg').build(),
            new GalleryEntryBuilder().setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image1.jpeg').build(),
            new GalleryEntryBuilder().setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image2.jpeg').build(),
            new GalleryEntryBuilder().setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image3.jpeg').build(),
