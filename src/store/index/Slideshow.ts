...
export const useSlideshowStore = defineStore('slideshow', {
    ...
    state: () => ({
        images: [
            ...
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image4.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image7.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image8.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image9.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image10.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image11.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image12.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image13.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/image14.jpeg').build(),
            new GalleryEntryBuilder().setId('#gen.uuid#').setImageUrl('content.rtc-koeln.de/pages/index/slideshow/signal-2023-05-01-193158.jpeg').build(),
        ],
    }),
})
