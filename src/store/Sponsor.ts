...
export const useSponsorStore = defineStore('sponsor', {
    ...
    state: () => ({
        sponsors: [
            ...
            new SponsorBuilder().setId('cf95576c-6bb4-407d-ba63-41673566a249').setImageUrl('content.rtc-koeln.de/pages/sponsor/Ford.webp').setUrl('www.ford.de').build(),
            ...
            new SponsorBuilder().setId('1da469f0-7a83-473c-9682-7d8d7b82dd1a').setImageUrl('content.rtc-koeln.de/pages/sponsor/StoryImage.jpg').setUrl('www.storyimage.de').build(),
            new SponsorBuilder().setId('3539bfeb-5ed9-46cc-8678-ffeceb4a0d72').setImageUrl('content.rtc-koeln.de/pages/sponsor/Sebamed.png').setUrl('shop.sebamed.de').build(),
